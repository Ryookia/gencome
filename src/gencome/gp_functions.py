...
def multiple_mutator(individual, pset):
    ...
    if rng < cur_weight:
        logger.debug(f"Starting mutation: Uniform {str_individual_with_real_feature_names(individual)}")
    ...
    if rng < cur_weight:
        logger.debug(f"Starting mutation: Node Replace {str_individual_with_real_feature_names(individual)}")
    ...
    if rng < cur_weight:
        logger.debug(f"Starting mutation Insert {str_individual_with_real_feature_names(individual)}")
        ...
        return new_ind
    logger.debug(f"Starting mutation Shrink {str_individual_with_real_feature_names(individual)}")
